...
public:
    ...
    ComputeShader(VkDevice device, VkPhysicalDevice physicalDevice, VkCommandPool commandPool, VkQueue queue, VkExtent2D extent,
        VkRenderPass *renderPass, std::string path, Texture* storageTex, Texture* storageTexPrev, Texture* placementTex, Texture3D* lowResCloudShapeTex, Texture3D* hiResCloudShapeTex, Texture* curlTexture) :
